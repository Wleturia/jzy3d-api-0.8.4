...
//        JFrame.setDefaultLookAndFeelDecorated(true);
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl.glTexImage2D(GL.GL_TEXTURE_2D, 0, GL.GL_RGBA, imageWidth,
                imageHeight, 0, GL.GL_RGBA, GL.GL_UNSIGNED_BYTE, imageBuf0);
        ...
        gl.glTexParameteri(GL.GL_TEXTURE_2D, //
                GL.GL_TEXTURE_MIN_FILTER, GL.GL_NEAREST);
        gl.glTexImage2D(GL.GL_TEXTURE_2D, 0, GL.GL_RGBA, imageWidth,
                imageHeight, 0, GL.GL_RGBA, GL.GL_UNSIGNED_BYTE, imageBuf1);
    ...
    public void display(GLAutoDrawable drawable) {
         ...
         * glTexEnvf(GL.GL_TEXTURE_ENV, GL.GL_OPERAND0_RGB_ARB,
         * GL.GL_SRC_COLOR); glTexEnvf(GL.GL_TEXTURE_ENV, GL.GL_SOURCE1_RGB_ARB,
         * GL.GL_PREVIOUS_ARB); glTexEnvf(GL.GL_TEXTURE_ENV,
         ...
         * GL.GL_PREVIOUS_ARB); glTexEnvf(GL.GL_TEXTURE_ENV,
         * GL.GL_OPERAND1_RGB_ARB, GL.GL_SRC_COLOR);
         * glTexEnvf(GL.GL_TEXTURE_ENV, GL.GL_SOURCE2_RGB_ARB,
         * GL.GL_CONSTANT_ARB); glTexEnvf(GL.GL_TEXTURE_ENV,
         * GL.GL_OPERAND2_RGB_ARB, GL.GL_SRC_ALPHA);
         */
        constColor[3] = 0.2f;
        gl.glTexEnvfv(GL.GL_TEXTURE_ENV, //
                GL.GL_TEXTURE_ENV_COLOR, constColor, 0);
        gl.glBindTexture(GL.GL_TEXTURE_2D, texName[0]);
        gl.glTexEnvf(GL.GL_TEXTURE_ENV, GL.GL_TEXTURE_ENV_MODE, GL.GL_COMBINE);
         ...
         * GL.GL_OPERAND0_RGB_ARB, GL.GL_SRC_COLOR);
         * glTexEnvf(GL.GL_TEXTURE_ENV, GL.GL_SOURCE1_RGB_ARB,
         * GL.GL_PREVIOUS_ARB); glTexEnvf(GL.GL_TEXTURE_ENV,
         * GL.GL_OPERAND1_RGB_ARB, GL.GL_SRC_COLOR);
         */
