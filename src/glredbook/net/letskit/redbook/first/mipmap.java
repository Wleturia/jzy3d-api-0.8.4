...
//        JFrame.setDefaultLookAndFeelDecorated(true);
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl.glTexImage2D(GL.GL_TEXTURE_2D, 0, 3, 32, 32, 0, GL.GL_RGB,
                GL.GL_UNSIGNED_BYTE, mipmapImage32Buf);
        gl.glTexImage2D(GL.GL_TEXTURE_2D, 1, 3, 16, 16, 0, GL.GL_RGB,
                GL.GL_UNSIGNED_BYTE, mipmapImage16Buf);
        gl.glTexImage2D(GL.GL_TEXTURE_2D, 2, 3, 8, 8, 0, GL.GL_RGB,
                GL.GL_UNSIGNED_BYTE, mipmapImage8Buf);
        gl.glTexImage2D(GL.GL_TEXTURE_2D, 3, 3, 4, 4, 0, GL.GL_RGB,
                GL.GL_UNSIGNED_BYTE, mipmapImage4Buf);
        gl.glTexImage2D(GL.GL_TEXTURE_2D, 4, 3, 2, 2, 0, GL.GL_RGB,
                GL.GL_UNSIGNED_BYTE, mipmapImage2Buf);
        gl.glTexImage2D(GL.GL_TEXTURE_2D, 5, 3, 1, 1, 0, GL.GL_RGB,
