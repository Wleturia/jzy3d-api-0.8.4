...
/**
 * The {@link AbstractContourGenerator} provides various utility fonctions
...
public abstract class AbstractContourGenerator {
	...
	/**
	 * Method that a concrete contour generator should implement.
	 * 
	 * @param matrix a matrix of "pixel" to be set
	 * @param xRes number of x pixels
	 * @param yRes number of y pixels
	 */
