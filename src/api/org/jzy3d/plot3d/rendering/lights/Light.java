...
public class Light {
	...
	public void apply(GL gl, Coord3d scale){
		if(enabled){
	        ...
	        gl.glLightfv(GL.GL_LIGHT0, GL.GL_POSITION, positionZero, 0);
	        gl.glLightfv(GL.GL_LIGHT0, GL.GL_AMBIENT, ambiantColor.toArray(), 0);
	        gl.glLightfv(GL.GL_LIGHT0, GL.GL_DIFFUSE, diffuseColor.toArray(), 0);
	        gl.glLightfv(GL.GL_LIGHT0, GL.GL_SPECULAR, specularColor.toArray(), 0);
		}
		else
			gl.glDisable(GL.GL_LIGHTING);
	}
