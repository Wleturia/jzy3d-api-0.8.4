 ...
 * 
 * The {@link TextRenderer} allows computing the 2d position of a text in the window, according to its required position
 ...
 * currently used {@link TextBitmap}, is that the user may select any java Font, whereas the {@link TextBitmap}
 ...
 */
public class TextRenderer implements Renderer2d{
	public TextRenderer(ICanvas canvas){
	...
	public void paint(Graphics g){
        ...
        for(TextDescriptor t: textList){
			...
			// Convert from GL to J2D coordinates mode
			x = (int)t.position.x; 
