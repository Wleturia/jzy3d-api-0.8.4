...
public abstract class Enlightable extends AbstractWireframeable {
	
	
	protected void applyMaterial(GL gl){
		gl.glMaterialfv(GL.GL_FRONT, GL.GL_AMBIENT, materialAmbiantReflection.toArray(), 0);
        gl.glMaterialfv(GL.GL_FRONT, GL.GL_DIFFUSE, materialDiffuseReflection.toArray(), 0);
        gl.glMaterialfv(GL.GL_FRONT, GL.GL_SPECULAR, materialSpecularReflection.toArray(), 0);
        gl.glMaterialfv(GL.GL_FRONT, GL.GL_SHININESS, materialShininess, 0);
        //gl.glMaterialfv(GL.GL_FRONT, GL.GL_EMISSION, materialEmission.toArray(), 0);
	}
