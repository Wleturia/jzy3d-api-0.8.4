...
import org.jzy3d.plot3d.builder.concrete.RingInterpolator;
...
public class Builder {
	...
	public static AbstractDrawable buildRing(OrthonormalGrid grid, Mapper mapper, float ringMin, float ringMax, ColorMapper cmapper, Color factor){
	    OrthonormalTesselator tesselator = new RingInterpolator(ringMin, ringMax, cmapper, factor);
	    return tesselator.build(grid.apply(mapper));
	}
