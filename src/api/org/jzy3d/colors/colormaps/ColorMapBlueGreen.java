...
public class ColorMapBlueGreen implements IColorMap {
    ...
    private Color getColor( float x, float y, float z, float zMin, float zMax ){
        ...
        float r = (float) colorComponentAbsolute( rel_value/5, +0.125f, +0.875f, +0.500f, +0.500f );
        float v = (float) colorComponentAbsolute( rel_value, +0.125f, +1.250f, +0.500f, +0.750f );
