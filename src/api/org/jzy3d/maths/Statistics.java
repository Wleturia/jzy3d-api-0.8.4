...
public class Statistics {
     ...
     * values. If the input array is empty, the output value is Double.NaN
	 * 
     * @param values
     * @return
     */
    ...
    /**
	 * Computes the standard deviation of an array of doubles. NaN values are ignored during 
	 * the computation. If the input array is empty, the output value is Double.NaN
	 * 
	 * @param values
	...
	/**
	 * Compute the variance of an array of doubles. {@link variance} normalizes the
	 ...
	 * has at least one element. NaN values are ignored during the computation.
	 * 
	 * @param values
	 * @param levels a list of levels that must belong to [0;100]
	 * @param interpolated computes an interpolation of quantile when required quantile is not an exact vector id.
